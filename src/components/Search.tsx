    ...
    <div>
      ...
      <div className="ml-48 mt-10">
        ...
        {searchItems && (
          <div className="p-3">
            {location?.state?.data
              ?.filter((data: any) => data.name.includes(searchItems))
              .map((item: any) => {
                return (
                  <>
